...
* @returns {string}
*/
module.exports.cube333JZPScramble = function(prefix, suffix) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const ptr1 = passStringToWasm0(suffix, wasm.__wbindgen_export_3, wasm.__wbindgen_export_4);
        const len1 = WASM_VECTOR_LEN;
        wasm.cube333JZPScramble(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred3_0 = r0;
        deferred3_1 = r1;
...
module.exports.__wbindgen_closure_wrapper1614 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 808, __wbg_adapter_22);
    return addHeapObject(ret);
};
