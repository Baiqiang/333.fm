...
export default {
  ...
  tools: {
    ...
    frTrainer: {
      ...
      falseFrSolution: '最短形态解（假 FR）',
      correctSolution: '正确解（真 FR）',
      steps: {
        toggle: '解法解析',
        start: '起始',
        shapeTitle: '形态解（假 FR）分解',
        trueTitle: '真 FR 解分解',
        frDone: '真 FR ✓',
        falseFrDone: '假 FR（形态满足但奇偶不对）',
      ...
      help: {
        ...
        algCase: '棱 / 角',
        algMoves: '公式',
        trueFrTitle: '真 FR vs 假 FR',
        trueFrBody1: '只把角形和坏棱都做成 0 不一定是真 FR：若做 FR 过程中 U2/D2 的总数奇偶不对，就会得到假 FR（满足形态但仍需一个轴向半转才能还原）。',
        trueFrBody2: '因此，本工具给出的「正确解（真 FR）」已自动补齐奇偶，可在每个结果卡的「解法解析」中查看逐步分解，对照「形态解（假 FR）」与「真 FR 解」的差别。',
      },
      error: {
      ...
      practice: {
        ...
        submit: '提交答案',
        next: '下一题',
        resultCorrect: '真 FR ✓，答对了！',
        resultWrong: '未达到真 FR，请对照参考解学习。',
        resultFalseFr: '达到了 FR 形态但是假 FR（奇偶不对），需要补一个轴向半转。',
        yourSolution: '你的解法',
        historyTitle: '练习历史',
        historyClear: '清空历史',
        historyEmpty: '暂无练习记录',
