...
export default {
  ...
  funChallenge: {
    ...
    shortTitle: '趣味',
    past: '往期挑战',
    pending: '当前没有进行中的趣味挑战。',
    type: '类型',
    rules: '提交完整复原。排名使用本期选定的计步规则。',
    centerRestored: '中心已复原',
    centerNotRestored: '中心未复原',
    ...
    admin: {
      ...
      endTime: '结束时间',
      scrambles: '打乱',
      scramblesDescription: '可选，每行一个打乱；留空则自动生成。',
      recent: '最近挑战',
      start: '开始',
      end: '结束',
      delete: '删除',
  ...
  endlessChallenge: {
    title: '无尽挑战 - 隐藏条件',
    description: '每一关都有隐藏条件，提交解法后会判断是否触发条件。当所有条件都满足时，下一关开启。',
    autoRevealed: '自动揭示',
    rules: {
      title: '规则',
      submit: '提交一个有效解法。',
      conditions: '每关有若干隐藏条件（常规关卡 1-3 个，Boss 关卡 3-5 个）。',
      reveal: '当你的提交满足某个条件时，该条件会被揭示。',
      allMet: '当前关卡所有条件都满足后，下一关自动开启。',
      autoReveal: '如果某一关连续 3 天没有条件被触发，则自动揭示一个条件。',
      boss: '每 10 关（10、20、30...）为 Boss 关，条件更多。',
    },
    conditions: {
      title: '通关条件',
      hidden: '隐藏条件 — 提交解法以揭示',
      allMet: '所有条件已满足！下一关已解锁！',
    },
    conditionType: {
      movesEqual: '有解法正好 {moves} 步',
      movesEqualMulti: '有 {count} 个解法正好 {moves} 步',
      movesLe: '有解法不超过 {moves} 步',
      movesLeMulti: '有 {count} 个解法不超过 {moves} 步',
      movesGe: '有解法不少于 {moves} 步',
      movesGeMulti: '有 {count} 个解法不少于 {moves} 步',
      movesParity: '有解法的步数为{parity}',
      sameSolution: '{count} 人提交了相同解法',
      sameMoves: '{count} 人提交的解法步数相同',
      allDifferentMoves: '至少 {min} 人提交，且步数各不相同',
      totalSubmissions: '至少 {count} 人提交了解法',
      consecutiveMoves: '{count} 个提交的步数构成等差数列（公差 {diff}）',
    },
    parity: {
      'even': '偶数',
      'odd': '奇数',
  ...
  tools: {
    ...
    frTrainer: {
      ...
      leaveSliceHint: '关闭后将完整还原中层棱块（最短 FR 解，可用四个侧面半转复原）',
      falseFr: '形态解',
      trueFr: 'FR',
      parityOff: '奇偶不对',
      inputFalseFrNote: '形态已满足 FR，但奇偶不对，需补一个轴向半转才能还原。下方为 FR 完整解。',
      falseFrSolution: '最短形态解',
      correctSolution: '正确解（FR）',
      steps: {
        toggle: '解法解析',
        start: '起始',
        shapeTitle: '形态解分解',
        trueTitle: 'FR 解分解',
        frDone: 'FR ✓',
        falseFrDone: '形态满足但奇偶不对',
        triggerHint: '到达 FR trigger，可用 {alg} 收尾',
        clickHint: '点击步骤可在上方魔方中预览该步的状态',
      },
      help: {
        title: '说明',
        close: '关闭',
        intro: '下列示例均以 U/D 轴为 FR 轴；角形示例隐藏了所有棱、坏棱示例隐藏了所有角，淡色棱为该轴忽略的中层棱。',
        cornerTitle: '角形（角块）',
        edgeTitle: '坏棱（棱块）',
        algTitle: '常见 case 参考公式（UD 轴）',
        algCase: '棱 / 角',
        algMoves: '公式',
        trueFrTitle: 'FR 与奇偶',
        trueFrBody1: '只把角形和坏棱都做成 0 不一定是 FR：若做 FR 过程中 U2/D2 的总数奇偶不对，形态满足但仍需一个轴向半转才能还原。',
        trueFrBody2: '因此，本工具给出的「正确解（FR）」已自动补齐奇偶，可在「解法解析」中查看逐步分解，对照形态解与 FR 解的差别。',
      },
      error: {
        parse: '无法解析步骤：{token}（仅支持 U D R L F B 及 \' / 2）',
        notHtr: '输入序列未到达 HTR 状态，无法进行 FR 分析。请确认魔方已完成 HTR。',
      },
      axisSuffix: '轴',
      badEdges: '坏棱',
      corner: '角形',
      ...
      alreadyFr: '已是 FR',
      noSolution: '无法求解',
      highlightTip: '切换要观察的轴',
      practice: {
        axisPrompt: '选择要练习的 FR 轴',
        randomAxis: '随机轴',
        ...
        liveTrueFr: '已达到 FR',
        liveFalseFr: '已达到 FR 形态，但奇偶不对',
        submit: '提交答案',
        next: '下一题',
        resultCorrect: 'FR ✓，答对了！',
        resultWrong: '未达到 FR，请对照参考解学习。',
        resultFalseFr: '达到了 FR 形态但奇偶不对，需要补一个轴向半转。',
        yourSolution: '你的解法',
        historyTitle: '练习历史',
        historyClear: '清空历史',
        historyEmpty: '暂无练习记录',
  ...
  wca: {
    ...
    recon: {
      ...
      submitScrambleOnly: '仅提交打乱',
      scrambleOnlyHint: '如果这个比赛还没有打乱，你可以只提交打乱，不用提交解法。',
      scrambleValid: '打乱有效',
      invalidScramble: '无效的打乱',
      scrambleMustWrap: '打乱必须以 R\' U\' F 开头和结尾',
      description: '整体说明',
