...
export default {
  ...
  tools: {
    ...
    frTrainer: {
      ...
      falseFrSolution: 'Shortest shape solution (false FR)',
      correctSolution: 'Correct solution (true FR)',
      steps: {
        toggle: 'Solution breakdown',
        start: 'Start',
        shapeTitle: 'Shape solution (false FR)',
        trueTitle: 'True FR solution',
        frDone: 'True FR ✓',
        falseFrDone: 'False FR (shape met but parity off)',
      ...
      help: {
        ...
        algCase: 'Edge / Corner',
        algMoves: 'Alg',
        trueFrTitle: 'True FR vs False FR',
        trueFrBody1: 'Reaching 0 bad edges and the 0 corner shape is not always true FR: if the parity of U2/D2 turns is wrong you get a false FR (shape is met but one more axis half-turn is still needed).',
        trueFrBody2: 'The tool\'s correct (true-FR) solution is already parity-fixed; open Solution breakdown on each result card to compare the shape (false-FR) vs the true-FR solution.',
      },
      error: {
      ...
      practice: {
        ...
        submit: 'Submit',
        next: 'Next',
        resultCorrect: 'True FR ✓ — correct!',
        resultWrong: 'Not true FR yet. Compare with the reference solution below.',
        resultFalseFr: 'FR shape reached but false FR (parity off); one more axis half-turn is needed.',
