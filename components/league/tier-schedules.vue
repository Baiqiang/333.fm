...
<template>
  ...
  <template v-for="{ competition, duels } of grouppedSchedules" :key="competition.id">
    <div class="col-span-5 col-start-5 grid grid-cols-subgrid mt-2">
      <div class="col-span-4 flex items-center bg-indigo-50 dark:bg-indigo-900/50 border border-r-0 border-indigo-200 dark:border-indigo-700 p-2 shadow-xs">
        <div class="font-semibold text-indigo-700 dark:text-indigo-300 mr-3">
